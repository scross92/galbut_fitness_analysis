...
lm_trt <- df %>% filter(is.finite(sex_ratio)) %>% filter(strain=="DGRP-399") %>% lm(sex_ratio ~ galbut, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)


lm_trt <- df %>% filter(is.finite(sex_ratio)) %>% filter(strain=="DGRP-517") %>% lm(sex_ratio ~ galbut, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)
...
lm_trt <- df %>% filter(strain=="DGRP-399") %>% lm(female_offspring ~ galbut, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)

lm_trt <- df %>% filter(strain=="DGRP-517") %>% lm(female_offspring ~ galbut, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)
...
lm_trt <- df %>% filter(strain=="DGRP-399") %>% lm(male_offspring ~ galbut, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)

lm_trt <- df %>% filter(strain=="DGRP-517") %>% lm(male_offspring ~ galbut, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)
...
#statistics by wald test
lm_trt <- df %>% group_by(galbut) %>% lm(emerged_offspring ~ strain, data=.)
summary(lm_trt)
wald.test(Sigma = vcov(lm_trt), b = coef(lm_trt), Terms = 2)
```
